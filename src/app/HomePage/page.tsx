...
function HomePage() {
  return (
    <>
      <section className='bg-[#f4ebe2] px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row  md:items-center py-[50px]'>
        {/* Heading */}
        <div className='text-white w-full md:w-[50%]'>
          <div className='flex items-center'>
            ...
            <Image src="/foodText.png" alt="foo" width={85} height={85} className='ml-3'/>
          </div>

          <h1 className='text-[25px] md:text-[50px] font-bold whitespace-nowrap md:whitespace-normal'>

            {/* <span className='text-[#FF9F0D]'>Th</span>e Art of speed food Quality */}
            <span className='text-[#000]'>For Your Tast</span>

          </h1>

          <p className='text-[#000] text-[10px] md:text-[16px] font-normal'>
      ...
      <section className="bg-[#f4ebe2] px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row  md:items-center py-[50px]">
        ...
        <div className="text-white w-full md:w-[50%]">
          ...
          <h1 className="text-[20px] md:text-[50px] font-bold whitespace-nowrap md:whitespace-normal text-black">
            <span className="text-[#FF9F0D]">We</span> Create the best foody
            product
          </h1>

          <p className="text-[10px] md:text-[16px] font-normal text-black">
          ...
          <ul>
            <li className="text-[10px] md:text-[16px] font-normal mt-10 flex text-black">
              <span className="mr-[10px] text-black">
                <FaCheck />
              </span>{" "}
